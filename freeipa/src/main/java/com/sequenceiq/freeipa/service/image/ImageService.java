...
public class ImageService {
    ...
    public void create(Stack stack, ImageSettingsV4Request imageRequest) {
        ...
        image.setImageName("ami-00a6ece830a9d2cfb");
    ...
    private String createUserData(Stack stack, Future<PlatformParameters> platformParametersFuture) {
        ...
        try {
            ...
            return userDataBuilder.buildUserData(Platform.platform(stack.getCloudPlatform()), cbSshKeyDer, sshUser, platformParameters, saltBootPassword, cbCert);
