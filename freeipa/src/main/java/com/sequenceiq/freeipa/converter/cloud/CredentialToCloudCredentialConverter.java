...
public class CredentialToCloudCredentialConverter implements Converter<Credential, CloudCredential> {
    ...
    public CloudCredential convert(Credential credential) {
        ...
        if (credential.getId() == null) {
            fields = isEmpty(credential.getAttributes().getSecret()) ? new HashMap<>() : new Json(credential.getAttributes().getSecret()).getMap();
        } else {
            fields = new Json(credential.getAttributes().getSecret()).getMap();
        }
